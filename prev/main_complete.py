...
class CompleteCognitiveTextBrain:
    ...
    def _setup_event_connections(self):
        ...
        self.event_bus.subscribe("action_planned",
                                 self._route_to_reasoning)

        # Reasoning → Global Workspace flow
        self.event_bus.subscribe("reasoning_complete",
                                 self._send_to_global_workspace)

        # Global Workspace → Production flow
        self.event_bus.subscribe("global_workspace_broadcast",
                                 self._trigger_response_generation)

        # Memory consolidation triggers
        self.event_bus.subscribe("high_memory_pressure",
...
def print_help():
    ...
    print("""
        ...
        - "How is the brain similar to a computer network?"
